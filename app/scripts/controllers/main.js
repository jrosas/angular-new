...
projectXCtrl.controller('MainCtrl', [ '$scope', 'graphSales', 'Invoices', 'Sales', 'Nidsales', 'Idsales','dailyRecurrence','dailyNew', 'dailyRecuNew', 'DailyStats','AverageStats', '$cookieStore', function ($scope, graphSales, Invoices, Sales, Nidsales, Idsales ,dailyRecurrence, dailyNew, dailyRecuNew, DailyStats, AverageStats, $cookieStore) {
